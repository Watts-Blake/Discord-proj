...
def seed_users():
    ...
    db.session.commit()
    aa = [ {'username': 'Blake', 'email': 'blake@demo.com', 'password': 'blake', 'profile_picture': 'https://avatars.githubusercontent.com/u/92361048?s=400&u=6f5c92fc1e267d49288ae7d63a633436dfc3a949&v=4'},{'username': 'Yake', 'email': 'yake@demo.com', 'password': 'blake', 'profile_picture': 'https://avatars.githubusercontent.com/u/78247317?v=4'},{'username': 'Ali', 'email': 'ali@demo.com', 'password': 'blake', 'profile_picture': 'https://avatars.githubusercontent.com/u/55769045?v=4'}, {'username': 'Will', 'email': 'will@demo.com', 'password': 'blake', 'profile_picture': 'https://avatars.githubusercontent.com/u/93359204?v=4'},{'username': 'Nick', 'email': 'nick@demo.com', 'password': 'blake', 'profile_picture': 'https://avatars.githubusercontent.com/u/93935486?v=4'},{'username': 'ANT', 'email': 'ant@demo.com', 'password': 'blake', 'profile_picture': 'https://cdn.discordapp.com/attachments/912965425757835275/964557769476804608/Screen_Shot_2021-12-30_at_11.33.15_PM.png'},{'username': 'Braxton', 'email': 'brax@demo.com', 'password': 'blake', 'profile_picture': 'https://avatars.githubusercontent.com/u/46814977?v=4'}, ]

    for user in aa:
        new_user = User(username=user['username'], email=user['email'], password=user['password'], profile_picture=user['profile_picture'])
        db.session.add(new_user)
    akatsuki = [{'username': 'Itachi', 'email': 'itachi@demo.com', 'password': 'itachi', 'profile_picture': 'https://pm1.narvii.com/6689/fd31532cd6c492fe3f3d3e3e449336672a15c5ff_00.jpg'},{'username': 'Madara', 'email': 'madara@demo.com', 'password': 'itachi', 'profile_picture': 'https://www.pngitem.com/pimgs/m/122-1222641_beautiful-naruto-png-madara-funny-face-madara-uchiha.png'},{'username': 'Obito', 'email': 'obito@demo.com', 'password': 'itachi', 'profile_picture': 'https://i.pinimg.com/550x/2d/72/4a/2d724ac3c6db73eb619b4c6c957cdb60.jpg'},{'username': 'Nagato', 'email': 'nagato@demo.com', 'password': 'itachi', 'profile_picture': 'https://i.pinimg.com/736x/1a/9f/fb/1a9ffbfd168de648eef4c033061d7393--game-art-naruto.jpg'},{'username': 'Orochimaru', 'email': 'oruchimaru@demo.com', 'password': 'itachi', 'profile_picture': 'https://i.pinimg.com/236x/9b/06/68/9b06680c73cf145d20f9742bb7961779--naruto-pics-anime-naruto.jpg'}]
